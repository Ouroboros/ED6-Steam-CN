...
def func_06_1104():
    EventBegin(0x00)
    Fade(1000)
    SetChrPos(0x0101, 22220, 0, 12120, 90)
    SetChrPos(0x010A, 21720, 0, 12890, 90)
    OP_8C(0x000B, 270, 0)
...
def func_07_1654():
    EventBegin(0x00)
    Fade(1000)
    SetChrPos(0x0101, 24620, 0, 4960, 90)
    SetChrPos(0x010A, 24060, 0, 5730, 90)
    OP_8C(0x000A, 270, 0)
