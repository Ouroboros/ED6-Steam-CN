...
@scena.Code('Init')
def Init():
    OP_16(0x02, 0x00000FA0, 0xFFFBA2D0, 0xFFFB50C8, 0x0023001D)
...
@scena.Code('ReInit')
def ReInit():
    UnlockAchievement(0x02, 0xD3, 0x01, 0x00)
...
def func_03_4E1():
    UnlockAchievement(0x02, 0xD4, 0x01, 0x00)
    SetMapFlags(0x08000000)
...
def func_04_5FD():
    UnlockAchievement(0x02, 0xD5, 0x01, 0x00)
    SetMapFlags(0x08000000)
