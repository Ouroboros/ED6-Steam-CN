...
def Init():
    ...
    EventBegin(0x00)
    Fade(1000)
    ChrSetPos(0x0101, 15500, 4000, 43010, 90)
    ChrSetPos(0x00F7, 15490, 4000, 44530, 180)
    ChrSetPos(0x00F8, 14760, 4000, 45010, 180)
    ChrSetPos(0x00F9, 15520, 4000, 45770, 180)
    ...
    ChrSetPos(0x0004, 14740, 4000, 46100, 180)

    def _loc_429(): pass

    label('loc_429')

    CameraMove(15000, 4500, 43060, 0)
