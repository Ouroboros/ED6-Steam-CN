...
def PreInit():
    ...
    SetChrPos(0x0009, 4490, 1000, 8220, 0)
    ...
    SetChrFlags(0x0008, 0x0080)
    SetChrPos(0x0009, -2590, 0, 9570, 270)
    ...
    SetChrFlags(0x0008, 0x0080)
    SetChrPos(0x0009, -2590, 0, 9570, 180)
    ...
    SetChrPos(0x0008, 5290, 1000, 8740, 0)
    SetChrPos(0x0009, -2590, 0, 9570, 270)
