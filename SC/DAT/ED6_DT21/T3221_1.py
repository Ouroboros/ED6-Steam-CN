...
def Init():
    EventBegin(0x00)
    Fade(1000)
    ChrSetPos(0x0008, 2590, 250, 5360, 180)
    ChrSetPos(0x0101, 2000, 250, 3320, 0)
    ChrSetPos(0x0107, 3030, 250, 2920, 0)
    ChrSetPos(0x00F7, 1910, 250, 1820, 0)
    ChrSetPos(0x00F9, 3060, 250, 1500, 0)
    CameraMove(1350, 250, 4070, 0)
    OP_0D()
