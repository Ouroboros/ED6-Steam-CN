...
scena = createScenaWriter('R3202   ._SN')
...
def func_01_1F3():
    OP_16(0x02, 4000, -131000, -126000, 2293812)
...
# id: 0x0003 offset: 0x21C
@scena.Code('func_03_21C')
def func_03_21C():
    Return()

# id: 0x0004 offset: 0x21D
@scena.Code('func_04_21D')
def func_04_21D():
    FadeOut(300, 0, 100)
    TalkSetChrName('')
