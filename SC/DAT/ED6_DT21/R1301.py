...
def func_01_1A7():
    OP_16(0x02, 4000, -341000, -40000, 2293780)
...
def func_02_1EC():
    UnlockAchievement(0x02, 0x01CE, 0x00)
    ...
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x0362, 2, 0x1B12))
...
def func_03_308():
    UnlockAchievement(0x02, 0x01CF, 0x00)
    MapSetFlags(0x08000000)
    ...
    SetMessageWindowPos(72, 320, 56, 3)
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x0362, 3, 0x1B13))
