...
def func_01_174():
    ...
    ChrSetPos(0x0101, -119000, 0, 68680, 270)
    ...
    ChrSetPos(0x00F8, -118380, 0, 69420, 270)
    ChrSetPos(0x00F7, -117250, 0, 68490, 270)
    ChrSetPos(0x00F9, -118000, 0, 67990, 270)
    ...
    ChrSetPos(0x00F7, -118380, 0, 69420, 270)
    ChrSetPos(0x00F8, -117250, 0, 68490, 270)
    ChrSetPos(0x00F9, -118000, 0, 67990, 270)
    ...
    ChrSetPos(0x00F7, -118380, 0, 69420, 270)
    ChrSetPos(0x00F9, -117250, 0, 68490, 270)
    ChrSetPos(0x00F8, -118000, 0, 67990, 270)
...
def func_05_DEC():
    ...
    ChrSetPos(0x0008, -120720, 0, 66270, 135)
    ChrSetPos(0x0101, -121860, 0, 65600, 90)
    ...
    ChrSetPos(0x00F8, -121860, 0, 64500, 90)
    ChrSetPos(0x00F9, -122900, 0, 65080, 90)
    ChrSetPos(0x00F7, -122900, 0, 66180, 90)
    ...
    ChrSetPos(0x00F7, -121860, 0, 64500, 90)
    ChrSetPos(0x00F9, -122900, 0, 65080, 90)
    ChrSetPos(0x00F8, -122900, 0, 66180, 90)
    ...
    ChrSetPos(0x00F7, -121860, 0, 64500, 90)
    ChrSetPos(0x00F8, -122900, 0, 65080, 90)
    ChrSetPos(0x00F9, -122900, 0, 66180, 90)
    ...
    FadeIn(1000, 0)
    OP_0D()
    ChrSetPos(0x000B, -118000, 0, 62730, 0)
    ChrSetRGBAMask(0x000B, 255, 255, 255, 0, 0)
    ChrSetFlags(0x000B, 0x0040)
    ChrSetPos(0x0009, -118000, 0, 62730, 0)
    ...
    ChrWalkTo(0x000B, -118000, 0, 64530, 2000, 0x00)
    ...
    ChrWalkTo(0x000B, -118000, 0, 62730, 2000, 0x00)
    ...
    def lambda_22A8():
        CameraMove(-121200, 0, 66520, 2000)

        ExitThread()

    DispatchAsync(0x0101, 0x0001, lambda_22A8)

    ChrWalkTo(0x0009, -119080, 0, 66270, 2000, 0x00)
    ...
    CloseMessageWindow()
    ChrWalkTo(0x0008, -119760, 0, 66290, 2000, 0x00)
    ChrSetDirection(0x0009, 135, 400)

    @scena.Lambda('lambda_3542')
    def lambda_3542():
        ChrWalkTo(0x0008, -119490, 0, 66180, 2000, 0x00)
    ...
    def lambda_355D():
        ChrWalkTo(0x0009, -118590, 0, 65760, 2000, 0x00)
...
def func_06_36C8():
    ...
    ChrWalkTo(0x00FE, -118000, 0, 64530, 2000, 0x00)
    ChrWalkTo(0x00FE, -118370, 0, 65129, 2000, 0x00)
...
def func_07_370F():
    ...
    ChrWalkTo(0x00FE, -118000, 0, 64530, 2000, 0x00)
    ChrWalkTo(0x00FE, -118910, 0, 64530, 2000, 0x00)
    ChrTurnDirection(0x00FE, 0x0008, 400)
