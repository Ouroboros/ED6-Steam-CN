...
def func_01_1BA():
    ...
    ChrSetPos(0x0009, -20, 250, 8200, 270)
    OP_A1(0x0009, 0x0003)
    OP_72(0x0003, 0x0004)
    PlaySE(161, 0x01, 0xC8)
    PlaySE(207, 0x01, 0x64)
    CreateThread(0x0009, 0x01, 0x00, func_02_208)
...
def func_03_23B():
    ...
    FadeIn(1000, 0)
    OP_0D()
    CreateThread(0x0101, 0x01, 0x00, func_04_A4C)
    CreateThread(0x0102, 0x01, 0x00, func_05_AB8)
    CreateThread(0x00F8, 0x01, 0x00, func_06_B29)
    CreateThread(0x00F9, 0x01, 0x00, func_07_B76)

    @scena.Lambda('lambda_02CF')
    def lambda_02CF():
        CameraMove(-1190, 0, 5790, 5000)
...
def func_04_A4C():
    ...
    ChrWalkTo(0x00FE, 490, 0, 4590, 2000, 0x00)
    Sleep(500)
...
def func_05_AB8():
    ...
    ChrWalkTo(0x00FE, -580, 0, 4510, 2000, 0x00)
    Sleep(500)
...
def func_06_B29():
    ...
    ChrWalkTo(0x00FE, 850, 0, 3350, 2000, 0x00)
...
def func_07_B76():
    ...
    ChrWalkTo(0x00FE, -650, 0, 3400, 2000, 0x00)
...
def func_09_D52():
    ...
    def lambda_0E21():
        ChrWalkTo(0x00FE, 1460, 0, 4650, 3000, 0x00)
    ...
    def lambda_0E41():
        ChrWalkTo(0x00FE, -200, 250, 7570, 3000, 0x00)
    ...
    def lambda_0E5F():
        ChrWalkTo(0x00FE, -1670, 0, 4630, 3000, 0x00)
    ...
    ChrWalkTo(0x0107, -1350, 250, 7890, 3000, 0x00)
    ChrSetDirection(0x0107, 270, 300)
    OP_62(0x0107, 0x00000000, 1700, 0x26, 0x26, 0x000000FA, 0x01)
    Sleep(1500)

    ChrWalkTo(0x0107, -1380, 250, 6670, 3000, 0x00)
    ChrSetDirection(0x0107, 270, 300)
    OP_62(0x0107, 0x00000000, 1700, 0x00, 0x01, 0x000000FA, 0x02)
    PlaySE(38, 0x00, 0x64)
    Sleep(1500)

    ChrWalkTo(0x0107, 2500, 0, 5650, 4000, 0x00)
    ChrSetDirection(0x0107, 90, 300)
    OP_62(0x0107, 0x00000000, 1700, 0x28, 0x2B, 0x00000064, 0x03)
    Sleep(1500)

    ChrWalkTo(0x0107, 550, 250, 6470, 3000, 0x00)
    ChrWalkTo(0x0107, 160, 250, 8840, 3000, 0x00)
    ...
    FadeOut(1000, 0, -1)
    OP_0D()
    CameraMove(-220, 0, 4610, 0)
    OP_67(0, 6150, -10000, 0)
    CameraSetDistance(2750, 0)
    OP_6C(315000, 0)
    OP_6E(280, 0)
    ChrSetPos(0x0000, -220, 0, 4610, 180)
    ChrSetPos(0x0001, -220, 0, 4610, 180)
    ChrSetPos(0x0002, -220, 0, 4610, 180)
    ChrSetPos(0x0003, -220, 0, 4610, 180)
    OP_69(0x0000, 0)
...
def func_0A_18E0():
    EventBegin(0x00)
    ChrSetPos(0x000A, -820, 0, 4090, 315)
    ChrSetPos(0x000B, -40, 0, 4090, 315)
    ChrSetPos(0x000C, 700, 0, 4090, 315)
    ChrSetPos(0x0009, -30, 0, 5200, 90)
    OP_A1(0x000A, 0x0000)
    OP_72(0x0000, 0x0004)
    OP_A1(0x000B, 0x0001)
    OP_72(0x0001, 0x0004)
    ...
    OP_A1(0x0009, 0x0003)
    OP_72(0x0003, 0x0004)
    ChrSetPos(0x0101, 850, 0, 1380, 0)
    ChrSetPos(0x0102, -350, 0, 1530, 0)
    ...
    ChrSetPos(0x00F8, 140, 0, 2750, 180)
    ChrSetPos(0x00F9, 270, 0, 190, 0)
    ...
    ChrSetPos(0x00F9, 140, 0, 2750, 180)
    ChrSetPos(0x00F8, 270, 0, 190, 0)

    def _loc_19C4(): pass

    label('loc_19C4')

    CameraMove(-970, 0, 3460, 0)
    ...
    OP_71(0x0001, 0x0004)
    OP_71(0x0002, 0x0004)
    ChrSetPos(0x0101, 450, 0, 4800, 0)
    ChrSetPos(0x0102, -670, 0, 4590, 0)
    ...
    ChrSetPos(0x00F8, -60, 0, 3240, 0)

    def _loc_1CF2(): pass

    label('loc_1CF2')

    ChrSetPos(0x0107, -10, 250, 6830, 0)
    LoadChip('ED6_DT07/CH00065._CH', 'ED6_DT07/CH00065P._CP', 3)
