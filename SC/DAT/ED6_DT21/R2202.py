...
@scena.Code('Init')
def Init():
    OP_16(0x02, 0x00000FA0, 0x00002710, 0xFFFB4128, 0x00230028)
...
def func_03_466():
    UnlockAchievement(0x02, 0xE5, 0x01, 0x00)
...
def func_04_582():
    UnlockAchievement(0x02, 0xE6, 0x01, 0x00)
    SetMapFlags(0x08000000)
...
def func_05_69E():
    UnlockAchievement(0x02, 0xE7, 0x01, 0x00)
    SetMapFlags(0x08000000)
