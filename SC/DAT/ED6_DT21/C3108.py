...
def ReInit():
    ...
    SetChrPos(0x0014, 570, 30000, 22920, 360)
    SetChrPos(0x0015, 570, 15000, 22920, 360)
    SetChrPos(0x0016, 10000, -10000, 54840, 270)
    OP_A1(0x0014, 0x0000)
    OP_A1(0x0015, 0x0001)
    OP_A1(0x0016, 0x0002)
    ...
    OP_6B(11040, 0)
    UnlockAchievement(0x64, 0x01, 0x00, 0x00)
    OP_6C(45000, 0)
    OP_6E(150, 0)
    ...
    OP_6B(9000, 10000)
    UnlockAchievement(0x64, 0x02, 0x00, 0x00)
    ...
    def lambda_0497():
        OP_91(0x00FE, 0, -15000, 0, 2000, 0x00)
    ...
    def lambda_04B2():
        OP_91(0x00FE, 0, -23000, 0, 6000, 0x00)
    ...
    def lambda_04D2():
        OP_91(0x00FE, 0, -23000, 0, 4000, 0x00)
    ...
    def lambda_04F2():
        OP_91(0x00FE, 0, -23000, 0, 3600, 0x00)
    ...
    def lambda_0512():
        OP_91(0x00FE, 0, -23000, 0, 3200, 0x00)
    ...
    def lambda_0532():
        OP_91(0x00FE, 0, -23000, 0, 2800, 0x00)
    ...
    def lambda_0552():
        OP_91(0x00FE, 0, -23000, 0, 2400, 0x00)
    ...
    def lambda_057C():
        OP_91(0x00FE, 0, -23000, 0, 2000, 0x00)
    ...
    SetChrPos(0x0014, 570, 100, 22920, 360)
    SetChrPos(0x0015, 570, 100, 22920, 360)
    OP_6D(-15480, 15220, 18720, 0)
    OP_67(0, 9940, -10000, 0)
    OP_6B(2980, 0)
    UnlockAchievement(0x64, 0x03, 0x00, 0x00)
    OP_6C(31000, 0)
    OP_6E(367, 0)
    SetChrBattleFlags(0x000E, 0x0020)
    SetChrBattleFlags(0x000F, 0x0020)
    SetChrBattleFlags(0x0010, 0x0020)
    ...
    CreateThread(0x0012, 0x01, 0x00, 0x0005)
    Sleep(500)

    CreateThread(0x0013, 0x01, 0x00, 0x0006)
    Sleep(1000)
    ...
    UnlockAchievement(0x64, 0x04, 0x00, 0x00)
    ...
    OP_6B(3510, 5000)
    UnlockAchievement(0x64, 0x05, 0x00, 0x00)
    ...
    SetChrPos(0x000D, -10930, 0, 35080, 72)
    ...
    def lambda_0954():
        OP_8E(0x00FE, -5550, 0, 40510, 2000, 0x00)
...
def func_03_D53():
    ...
    OP_8E(0x00FE, -10090, 0, 23580, 4000, 0x00)
    OP_8E(0x00FE, -8820, 0, 39140, 4000, 0x00)
    OP_8E(0x00FE, 1280, 0, 46840, 4000, 0x00)
...
def func_04_D9C():
    ClearChrFlags(0x00FE, 0x0080)
    OP_8E(0x00FE, -10420, 0, 23770, 4000, 0x00)
    OP_8E(0x00FE, -8930, 0, 38070, 4000, 0x00)
    OP_8E(0x00FE, -180, 0, 46870, 4000, 0x00)
    OP_8C(0x00FE, 0, 400)
...
def func_05_DE5():
    ClearChrFlags(0x00FE, 0x0080)
    OP_8E(0x00FE, -10230, 0, 23130, 4000, 0x00)
    OP_8E(0x00FE, -8930, 0, 36070, 4000, 0x00)
    OP_8E(0x00FE, -2360, 0, 47470, 4000, 0x00)
...
def func_06_E2E():
    ClearChrFlags(0x00FE, 0x0080)
    OP_8E(0x00FE, -10640, 0, 23910, 4000, 0x00)
    OP_8E(0x00FE, -8930, 0, 36070, 4000, 0x00)
    OP_8E(0x00FE, -3510, 0, 47560, 4000, 0x00)
    OP_8C(0x00FE, 0, 45)
...
def func_07_E77():
    ClearChrFlags(0x00FE, 0x0080)
    OP_8E(0x00FE, -10230, 0, 23130, 4000, 0x00)
    OP_8E(0x00FE, -8930, 0, 37070, 4000, 0x00)
    OP_8E(0x00FE, -1020, 0, 42350, 4000, 0x00)
    OP_8C(0x00FE, 360, 400)
...
def func_08_EC0():
    ClearChrFlags(0x00FE, 0x0080)
    OP_8E(0x00FE, -10640, 0, 23910, 4000, 0x00)
    OP_8E(0x00FE, -7160, 0, 39220, 4000, 0x00)
    OP_8E(0x00FE, -2900, 0, 42440, 4000, 0x00)
    OP_8C(0x00FE, 360, 400)
...
def func_09_F09():
    ...
    OP_A1(0x000B, 0x0002)
    OP_A1(0x000C, 0x0000)
    SetChrPos(0x0009, 1620, 0, 23850, 0)
    SetChrPos(0x000A, 10180, -10450, 61010, 0)
    SetChrPos(0x000B, 28590, -10450, 60800, 0)
    SetChrPos(0x000C, -8380, -10450, 60710, 0)
    OP_A1(0x0017, 0x0007)
    OP_A1(0x0018, 0x0005)
    OP_A1(0x0019, 0x0006)
    OP_A1(0x001A, 0x0004)
    SetChrPos(0x0017, 1620, 100, 23850, 0)
    SetChrPos(0x0018, 10180, -10450, 61010, 0)
    SetChrPos(0x0019, 28590, -10450, 60800, 0)
    SetChrPos(0x001A, -8380, -10450, 60710, 0)
    ClearMapFlags(0x00000010)
    SetChrPos(0x0008, 10750, 0, 30020, 270)
    ...
    CreateThread(0x0009, 0x00, 0x00, 0x000A)
...
def func_0B_12D6():
    ...
    OP_91(0x00FE, 0, 1000, 0, 1500, 0x00)
    OP_91(0x00FE, 0, 3000, 0, 2000, 0x00)
    OP_91(0x00FE, 0, 4000, 0, 3000, 0x00)
    OP_82(0x01, 0x02)
    OP_91(0x00FE, 0, 4000, 0, 4000, 0x00)
    ...
    def lambda_13C5():
        OP_8F(0x00FE, 1620, 20000, -33600, 6000, 0x00)
    ...
    def lambda_13E0():
        OP_8F(0x00FE, 1620, 100, -33600, 6000, 0x00)
    ...
    def lambda_1400():
        OP_8F(0x00FE, 1620, 20000, -33600, 10000, 0x00)
    ...
    def lambda_141B():
        OP_8F(0x00FE, 1620, 100, -33600, 10000, 0x00)
    ...
    def lambda_143B():
        OP_8F(0x00FE, 1620, 20000, -33600, 15000, 0x00)
    ...
    def lambda_1456():
        OP_8F(0x00FE, 1620, 100, -33600, 15000, 0x00)
    ...
    def lambda_1476():
        OP_8F(0x00FE, 1620, 20000, -33600, 18000, 0x00)
    ...
    def lambda_1491():
        OP_8F(0x00FE, 1620, 100, -33600, 18000, 0x00)
    ...
    def lambda_14B1():
        OP_8F(0x00FE, 1620, 20000, -33600, 21000, 0x00)
    ...
    def lambda_14CC():
        OP_8F(0x00FE, 1620, 100, -33600, 21000, 0x00)
    ...
    def lambda_14EC():
        OP_8F(0x00FE, 1620, 20000, -33600, 25000, 0x00)
    ...
    def lambda_1507():
        OP_8F(0x00FE, 1620, 100, -33600, 25000, 0x00)
    ...
    def lambda_1527():
        OP_8F(0x00FE, 1620, 20000, -33600, 30000, 0x00)
    ...
    def lambda_1542():
        OP_8F(0x00FE, 1620, 100, -33600, 30000, 0x00)
    ...
    def lambda_1562():
        OP_8F(0x00FE, 1620, 20000, -33600, 35000, 0x00)
    ...
    def lambda_157D():
        OP_8F(0x00FE, 1620, 100, -33600, 35000, 0x00)
...
def func_0C_1593():
    ...
    def lambda_16B9():
        OP_91(0x00FE, 0, 450, 0, 2000, 0x00)
    ...
    def lambda_1704():
        OP_8F(0x00FE, 10180, 20000, -33600, 6000, 0x00)
    ...
    def lambda_171F():
        OP_8F(0x00FE, 10180, 0, -33600, 6000, 0x00)
    ...
    def lambda_173F():
        OP_8F(0x00FE, 10180, 20000, -33600, 10000, 0x00)
    ...
    def lambda_175A():
        OP_8F(0x00FE, 10180, 0, -33600, 10000, 0x00)
    ...
    def lambda_177A():
        OP_8F(0x00FE, 10180, 20000, -33600, 15000, 0x00)
    ...
    def lambda_1795():
        OP_8F(0x00FE, 10180, 0, -33600, 15000, 0x00)
    ...
    def lambda_17B5():
        OP_8F(0x00FE, 10180, 20000, -33600, 18000, 0x00)
    ...
    def lambda_17F0():
        OP_8F(0x00FE, 10180, 20000, -33600, 21000, 0x00)
    ...
    def lambda_180B():
        OP_8F(0x00FE, 10180, 0, -33600, 21000, 0x00)
    ...
    def lambda_182B():
        OP_8F(0x00FE, 10180, 20000, -33600, 25000, 0x00)
    ...
    def lambda_1846():
        OP_8F(0x00FE, 10180, 0, -33600, 25000, 0x00)
    ...
    def lambda_1866():
        OP_8F(0x00FE, 10180, 20000, -33600, 30000, 0x00)
    ...
    def lambda_1881():
        OP_8F(0x00FE, 10180, 0, -33600, 30000, 0x00)
    ...
    def lambda_18A1():
        OP_8F(0x00FE, 10180, 20000, -33600, 35000, 0x00)
    ...
    def lambda_18BC():
        OP_8F(0x00FE, 10180, 0, -33600, 35000, 0x00)
...
def func_0D_18D2():
    ...
    def lambda_19BC():
        OP_8F(0x00FE, 28590, 20000, -33600, 6000, 0x00)
    ...
    def lambda_19D7():
        OP_8F(0x00FE, 28590, -10450, -33600, 6000, 0x00)
    ...
    def lambda_19F7():
        OP_8F(0x00FE, 28590, 20000, -33600, 10000, 0x00)
    ...
    def lambda_1A12():
        OP_8F(0x00FE, 28590, -10450, -33600, 10000, 0x00)
    ...
    def lambda_1A32():
        OP_8F(0x00FE, 28590, 20000, -33600, 15000, 0x00)
    ...
    def lambda_1A4D():
        OP_8F(0x00FE, 28590, -10450, -33600, 15000, 0x00)
    ...
    def lambda_1A88():
        OP_8F(0x00FE, 28590, -10450, -33600, 18000, 0x00)
    ...
    def lambda_1AA8():
        OP_8F(0x00FE, 28590, 20000, -33600, 21000, 0x00)
    ...
    def lambda_1AC3():
        OP_8F(0x00FE, 28590, -10450, -33600, 21000, 0x00)
    ...
    def lambda_1AE3():
        OP_8F(0x00FE, 28590, 20000, -33600, 25000, 0x00)
    ...
    def lambda_1AFE():
        OP_8F(0x00FE, 28590, -10450, -33600, 25000, 0x00)
    ...
    def lambda_1B1E():
        OP_8F(0x00FE, 28590, 20000, -33600, 30000, 0x00)
    ...
    def lambda_1B39():
        OP_8F(0x00FE, 28590, -10450, -33600, 30000, 0x00)
    ...
    def lambda_1B59():
        OP_8F(0x00FE, 28590, 20000, -33600, 35000, 0x00)
    ...
    def lambda_1B74():
        OP_8F(0x00FE, 28590, -10450, -33600, 35000, 0x00)
...
def func_0E_1B8A():
    ...
    def lambda_1CFB():
        OP_8F(0x00FE, -8360, 20000, -33590, 6000, 0x00)
    ...
    def lambda_1D16():
        OP_8F(0x00FE, -8360, 0, -33590, 6000, 0x00)
    ...
    def lambda_1D36():
        OP_8F(0x00FE, -8360, 20000, -33590, 10000, 0x00)
    ...
    def lambda_1D51():
        OP_8F(0x00FE, -8360, 0, -33590, 10000, 0x00)
    ...
    def lambda_1D71():
        OP_8F(0x00FE, -8360, 20000, -63590, 15000, 0x00)
    ...
    def lambda_1D8C():
        OP_8F(0x00FE, -8360, 0, -63590, 15000, 0x00)
    ...
    def lambda_1DAC():
        OP_8F(0x00FE, -8360, 20000, -63590, 18000, 0x00)
    ...
    def lambda_1DC7():
        OP_8F(0x00FE, -8360, 0, -63590, 18000, 0x00)
    ...
    def lambda_1DE7():
        OP_8F(0x00FE, -8360, 20000, -63590, 21000, 0x00)
    ...
    def lambda_1E02():
        OP_8F(0x00FE, -8360, 0, -63590, 21000, 0x00)
    ...
    def lambda_1E22():
        OP_8F(0x00FE, -8360, 20000, -63590, 25000, 0x00)
    ...
    def lambda_1E3D():
        OP_8F(0x00FE, -8360, 0, -63590, 25000, 0x00)
    ...
    def lambda_1E5D():
        OP_8F(0x00FE, -8360, 20000, -63590, 30000, 0x00)
    ...
    def lambda_1E78():
        OP_8F(0x00FE, -8360, 0, -63590, 30000, 0x00)
    ...
    def lambda_1E98():
        OP_8F(0x00FE, -8360, 20000, -63590, 35000, 0x00)
    ...
    def lambda_1EB3():
        OP_8F(0x00FE, -8360, 0, -63590, 35000, 0x00)
