...
def PreInit():
    ...
    SetChrPos(0x000A, -132010, 0, 6440, 340)
    ...
    SetChrPos(0x000A, -132010, 0, 6440, 340)
    SetChrPos(0x000E, 3250, 0, 13250, 344)
    SetChrPos(0x000F, 4130, 0, 13250, 347)
    ...
    SetChrPos(0x0009, -132010, 0, 6440, 340)
    SetChrPos(0x000A, -75250, 0, 3670, 275)
    SetChrPos(0x000E, 3250, 0, 13250, 344)
    SetChrPos(0x000F, 4130, 0, 13250, 347)
    ...
    SetChrPos(0x000A, -540, 0, 14500, 103)
