...
def ReInit():
    ...
    SetChrPos(0x000D, -1910, -1000, -5900, 90)
    SetChrPos(0x000E, 160, -1400, -5250, 90)
    SetChrPos(0x000F, -720, -1000, -3310, 135)
    SetChrPos(0x0010, -1340, -1000, -4540, 90)
    ...
    SetChrPos(0x0011, -20430, 0, 440, 270)
    SetChrPos(0x0012, -20190, 0, 1910, 270)
    SetChrPos(0x0013, -18990, 0, 1800, 270)
    SetChrPos(0x0014, -17990, 0, 1380, 270)
    SetChrPos(0x0015, -17170, 0, -470, 270)
    SetChrPos(0x0016, -17100, 0, 200, 270)
    ...
    OP_63(0x0010)
    OP_63(0x000D)
    SetChrPos(0x0101, -3100, 0, 12790, 180)
    SetChrPos(0x0008, -4530, 0, 12880, 180)
    SetChrPos(0x000A, -4370, 0, 14000, 180)
    SetChrPos(0x000B, -5270, 0, 13810, 180)
    SetChrPos(0x0009, -3500, 0, 14100, 180)
    SetChrPos(0x000C, -2550, 0, 14100, 180)
    ...
    def lambda_081D():
        OP_8E(0x00FE, -3100, 0, 11800, 5000, 0x00)
    ...
    def lambda_1275():
        OP_8E(0x00FE, 1550, -1000, -4100, 2000, 0x00)
    ...
    def lambda_12AD():
        OP_8F(0x00FE, -1370, -1000, -3120, 2000, 0x00)
    ...
    def lambda_12CD():
        OP_8F(0x00FE, -1920, -1000, -4230, 2000, 0x00)
    ...
    def lambda_131E():
        OP_99(0x00FE, 0x00, 0x02, 0x000003E8)
    ...
    OP_B0(0x0002, 0xFA)
    OP_6F(0x0002, 0)
    OP_70(0x0002, 0x000000AA)
    Sleep(150)

    @scena.Lambda('lambda_1381')
    def lambda_1381():
        OP_99(0x00FE, 0x04, 0x09, 0x00000578)

        ExitThread()

    DispatchAsync(0x000C, 0x0002, lambda_1381)

    OP_22(0x0123, 0x00, 0x64)
...
def func_03_152B():
    OP_8E(0x00FE, -3510, -1000, 5990, 5000, 0x00)
...
def func_05_1564():
    ...
    OP_8E(0x00FE, -3510, -1000, 5990, 4500, 0x00)
    ClearChrFlags(0x00FE, 0x1000)
...
def func_06_1588():
    ...
    OP_8E(0x00FE, -8119, 0, 9780, 5000, 0x00)
    OP_8E(0x00FE, -13790, 0, 8730, 5000, 0x00)
    ClearChrFlags(0x00FE, 0x1000)
...
def func_07_15C5():
    ...
    OP_8E(0x00FE, -7510, 0, 10030, 5000, 0x00)
    OP_8E(0x00FE, -13260, 0, 8650, 5000, 0x00)
    ClearChrFlags(0x00FE, 0x1000)
    SetChrFlags(0x00FE, 0x0080)
...
def func_09_163F():
    ...
    OP_90(0x00FE, 0, 0, -1000, 2500, 0x00)
    OP_90(0x00FE, 0, 0, 1000, 2500, 0x00)
...
def func_0C_16C2():
    OP_8E(0x00FE, 710, -1000, 2580, 5000, 0x00)
    OP_8E(0x00FE, 650, -1000, -1790, 5000, 0x00)
...
def func_0D_16F7():
    ...
    SetChrChipByIndex(0x00FE, 17)
    OP_8E(0x00FE, 710, -1000, 2580, 5000, 0x00)
    OP_8E(0x00FE, -160, -1000, -920, 5000, 0x00)
...
def func_0E_1740():
    SetChrFlags(0x00FE, 0x1000)
    SetChrChipByIndex(0x00FE, 20)
    OP_8E(0x00FE, 710, -1000, 2580, 4500, 0x00)
    OP_8E(0x00FE, 1970, -1000, -1140, 4500, 0x00)
