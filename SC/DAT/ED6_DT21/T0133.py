...
def PreInit():
    ...
    SetChrPos(0x0008, 55710, 10300, 47580, 270)
    ClearChrFlags(0x0009, 0x0080)
    SetChrPos(0x0009, 54840, 10300, 46250, 270)
...
def func_06_E66():
    UnlockAchievement(0x01, 0x05, 0x00, 0x00)
    TalkBegin(0x000A)
...
def func_07_FB9():
    ...
    OP_AD(0x002400D1, 0x0000, 0x0000, 0x000001F4)
    Sleep(500)
