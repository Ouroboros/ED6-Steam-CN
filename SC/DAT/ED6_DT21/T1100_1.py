...
def Init():
    ...
    EventBegin(0x00)
    Fade(1000)
    ChrSetPos(0x0101, 65390, 3000, 33170, 0)
    ChrSetPos(0x00F7, 65090, 3000, 31150, 0)
    ChrSetPos(0x00F8, 66060, 3000, 31080, 0)
    ChrSetPos(0x00F9, 65600, 3000, 30290, 0)
    ...
    ChrSetPos(0x0004, 64830, 3000, 29670, 0)

    def _loc_42D(): pass

    label('loc_42D')

    CameraMove(65390, 3000, 32689, 0)
    ...
    def lambda_0986():
        CameraMove(65470, 3000, 35800, 2000)

        ExitThread()

    DispatchAsync(0x00F7, 0x0002, lambda_0986)

    ChrWalkTo(0x0101, 65390, 3000, 35740, 2000, 0x00)
    Sleep(1000)
    ...
    def lambda_0A41():
        CameraMove(65470, 3000, 32689, 2000)

        ExitThread()

    DispatchAsync(0x00F7, 0x0002, lambda_0A41)

    ChrWalkTo(0x0101, 65390, 3000, 33170, 2000, 0x00)
    WaitForThreadExit(0x00F7, 0x0002)
