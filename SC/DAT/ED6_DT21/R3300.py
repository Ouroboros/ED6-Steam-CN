...
def func_01_24F():
    OP_16(0x02, 4000, -137000, -75000, 2293813)
...
def func_03_2C1():
    ...
    CloseMessageWindow()
    OP_56(0x00)
    SetScenaFlags(ScenaFlag(0x029F, 6, 0x14FE))
...
def func_04_47C():
    UnlockAchievement(0x02, 0x01F2, 0x00)
    ...
    SetMessageWindowPos(72, 320, 56, 3)
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x02A2, 0, 0x1510))
