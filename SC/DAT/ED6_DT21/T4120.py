...
def func_04_393():
    ...
    EventBegin(0x00)
    Fade(1000)
    SetChrPos(0x0101, 60400, 0, -60, 270)
    SetChrPos(0x0102, 60400, 0, 800, 270)
    ...
    SetChrPos(0x00F9, 61510, 0, -60, 270)
    SetChrPos(0x00F8, 61510, 0, 800, 270)
    ...
    SetChrPos(0x00F8, 61510, 0, -60, 270)
    SetChrPos(0x00F9, 61510, 0, 800, 270)
