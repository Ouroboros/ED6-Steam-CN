...
@scena.Code('Init')
def Init():
    OP_16(0x02, 0x00000FA0, 0xFFFDECC0, 0xFFFF34E0, 0x00230025)
    OP_25(0x01C5, 0xFFFFF092, 0x000003E8, 0x00020FC6, 0x00002710, 0x00009C40, 0x64, 0x00000000)
...
@scena.Code('ReInit')
def ReInit():
    UnlockAchievement(0x02, 0xE9, 0x01, 0x00)
