...
@scena.Code('ReInit')
def ReInit():
    UnlockAchievement(0x02, 0xC7, 0x00, 0x00)
...
def func_03_30C():
    UnlockAchievement(0x02, 0xC8, 0x00, 0x00)
    SetMapFlags(0x08000000)
...
def func_04_428():
    UnlockAchievement(0x02, 0xC9, 0x00, 0x00)
    SetMapFlags(0x08000000)
...
def func_05_544():
    UnlockAchievement(0x02, 0xCA, 0x00, 0x00)
    SetMapFlags(0x08000000)
    FadeOut(300, 0, 100)
