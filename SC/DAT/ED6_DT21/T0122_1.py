...
def PreInit():
    ...
    OP_8C(0x00FE, 180, 0)
    Fade(1000)
    SetChrPos(0x0101, -40360, 0, -4070, 270)
    SetChrPos(0x0103, -39740, 0, -4770, 270)
    SetChrPos(0x00F8, -38890, 0, -3380, 270)
    SetChrPos(0x00F9, -38350, 0, -4310, 270)
    ...
    SetChrPos(0x00F9, -38890, 0, -3380, 270)
    SetChrPos(0x00F8, -38350, 0, -4310, 270)
