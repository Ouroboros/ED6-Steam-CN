...
@scena.Code('Init')
def Init():
    OP_16(0x02, 0x00000FA0, 0xFFF9E580, 0xFFFDF490, 0x0023000D)
...
def func_05_944():
    UnlockAchievement(0x02, 0x09, 0x02, 0x00)
...
def func_06_B19():
    UnlockAchievement(0x02, 0xC5, 0x01, 0x00)
    SetMapFlags(0x08000000)
...
def func_07_C35():
    UnlockAchievement(0x02, 0xC6, 0x01, 0x00)
    SetMapFlags(0x08000000)
