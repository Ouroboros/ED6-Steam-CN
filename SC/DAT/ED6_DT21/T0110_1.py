...
def Init():
    EventBegin(0x00)
    Fade(1000)
    SetChrPos(0x0101, 91960, 0, 162870, 90)
    SetChrPos(0x00F7, 91150, 0, 162270, 90)
    SetChrPos(0x00F8, 90480, 0, 163570, 90)
    SetChrPos(0x00F9, 91330, 0, 164280, 135)
    OP_8C(0x00FE, 270, 0)
