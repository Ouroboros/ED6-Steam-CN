...
def Init():
    ...
    ChrSetPos(0x0009, 206990, -20, 101510, 45)
...
def func_05_4A9():
    ...
    SetScenaFlags(ScenaFlag(0x0412, 7, 0x2097))
    ...
    CloseMessageWindow()
    SetScenaFlags(ScenaFlag(0x0349, 7, 0x1A4F))
    ...
    CloseMessageWindow()
    SetScenaFlags(ScenaFlag(0x0349, 6, 0x1A4E))
...
def func_09_1858():
    ...
    CloseMessageWindow()
    SetScenaFlags(ScenaFlag(0x034A, 0, 0x1A50))
