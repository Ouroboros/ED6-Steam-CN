...
def PreInit():
    ...
    SetChrPos(0x000A, -41280, 0, 35500, 0)
    SetChrPos(0x0009, -42700, 0, 37200, 90)
...
def func_0C_BBD():
    ...
    OP_4A(0x000A, 255)
    Fade(1000)
    SetChrPos(0x0101, -42370, 0, 34440, 0)
    SetChrPos(0x0103, -41320, 0, 34290, 0)
    SetChrPos(0x00F8, -42850, 0, 33200, 0)
    SetChrPos(0x00F9, -41450, 0, 33100, 0)
    OP_8C(0x000A, 180, 0)
    OP_8C(0x0009, 180, 0)
