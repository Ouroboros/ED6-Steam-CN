...
def Init():
    ...
    OP_16(0x02, 0x00000FA0, 0x0004E200, 0xFFFD44C8, 0x00230039)
...
def func_05_94A():
    UnlockAchievement(0x02, 0xFA, 0x01, 0x00)
...
def func_06_B1F():
    UnlockAchievement(0x02, 0xFB, 0x01, 0x00)
    SetMapFlags(0x08000000)
...
def func_07_C3B():
    UnlockAchievement(0x02, 0xFC, 0x01, 0x00)
    SetMapFlags(0x08000000)
