...
@scena.Code('Init')
def Init():
    ClearScenaFlags(ScenaFlag(0x026A, 0, 0x1350))
    ClearScenaFlags(ScenaFlag(0x026A, 1, 0x1351))
    ClearScenaFlags(ScenaFlag(0x026A, 2, 0x1352))
    ClearScenaFlags(ScenaFlag(0x026A, 3, 0x1353))
    ClearScenaFlags(ScenaFlag(0x026A, 4, 0x1354))
    ClearScenaFlags(ScenaFlag(0x026A, 5, 0x1355))
    ClearScenaFlags(ScenaFlag(0x026A, 6, 0x1356))
    ClearScenaFlags(ScenaFlag(0x026A, 7, 0x1357))
    ClearScenaFlags(ScenaFlag(0x026B, 0, 0x1358))
    ClearScenaFlags(ScenaFlag(0x026B, 1, 0x1359))
    ClearScenaFlags(ScenaFlag(0x03D3, 1, 0x1E99))
    ClearScenaFlags(ScenaFlag(0x03D3, 2, 0x1E9A))
    ClearScenaFlags(ScenaFlag(0x03D3, 3, 0x1E9B))
    ClearScenaFlags(ScenaFlag(0x03D3, 4, 0x1E9C))
    ClearScenaFlags(ScenaFlag(0x03D3, 5, 0x1E9D))
    ClearScenaFlags(ScenaFlag(0x03D3, 6, 0x1E9E))
    ClearScenaFlags(ScenaFlag(0x03D3, 7, 0x1E9F))
    ClearScenaFlags(ScenaFlag(0x03D4, 0, 0x1EA0))
    ClearScenaFlags(ScenaFlag(0x03D4, 1, 0x1EA1))
    ClearScenaFlags(ScenaFlag(0x03D4, 2, 0x1EA2))
    ClearScenaFlags(ScenaFlag(0x03D4, 3, 0x1EA3))
    ClearScenaFlags(ScenaFlag(0x03D4, 4, 0x1EA4))
    ClearScenaFlags(ScenaFlag(0x03D4, 5, 0x1EA5))
    ClearScenaFlags(ScenaFlag(0x03D4, 6, 0x1EA6))
    ClearScenaFlags(ScenaFlag(0x03D4, 7, 0x1EA7))
    ClearScenaFlags(ScenaFlag(0x03D5, 0, 0x1EA8))
    ClearScenaFlags(ScenaFlag(0x03D5, 1, 0x1EA9))
    ClearScenaFlags(ScenaFlag(0x03D5, 2, 0x1EAA))
    ClearScenaFlags(ScenaFlag(0x03D5, 3, 0x1EAB))
    ClearScenaFlags(ScenaFlag(0x03D5, 4, 0x1EAC))
    ClearScenaFlags(ScenaFlag(0x03D5, 5, 0x1EAD))
    ClearScenaFlags(ScenaFlag(0x03D5, 6, 0x1EAE))
    ClearScenaFlags(ScenaFlag(0x03D5, 7, 0x1EAF))
    ClearScenaFlags(ScenaFlag(0x03D6, 0, 0x1EB0))
    ClearScenaFlags(ScenaFlag(0x03D6, 1, 0x1EB1))
    ClearScenaFlags(ScenaFlag(0x03D6, 2, 0x1EB2))
    ClearScenaFlags(ScenaFlag(0x03D6, 3, 0x1EB3))
    ClearScenaFlags(ScenaFlag(0x03D6, 4, 0x1EB4))
...
def func_01_2A7():
    OP_16(0x02, 4000, -130000, -79000, 2293796)
...
@scena.Code('func_02_399')
def func_02_399():
    UnlockAchievement(0x02, 0x01E8, 0x00)
    ...
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x0261, 7, 0x130F))
...
def func_03_4B5():
    ...
    CloseMessageWindow()
    OP_56(0x00)
    SetScenaFlags(ScenaFlag(0x041F, 3, 0x20FB))
...
def func_04_670():
    ...
    CameraMove(-1330, 20, 82650, 0)
    OP_67(0, 12040, -10000, 0)
    CameraSetDistance(3100, 0)
    OP_6C(45000, 0)
    OP_6E(341, 0)
    ChrSetPos(0x0101, 280, -30, 13880, 0)
    ChrSetPos(0x0102, -1200, -10, 13760, 0)
    ChrSetPos(0x0103, 280, 0, 12600, 0)
    ChrSetPos(0x00F9, -1140, 20, 12330, 0)

    @scena.Lambda('lambda_0716')
    def lambda_0716():
        CameraMove(-450, 20, 21490, 7000)
    ...
    def lambda_075C():
        ChrWalkTo(0x00FE, 10, 20, 21400, 2000, 0x00)
    ...
    def lambda_0777():
        ChrWalkTo(0x00FE, -1220, 20, 21400, 2000, 0x00)
    ...
    def lambda_0792():
        ChrWalkTo(0x00FE, -50, 20, 20190, 2000, 0x00)
    ...
    def lambda_07AD():
        ChrWalkTo(0x00FE, -1470, 0, 20090, 2000, 0x00)
    ...
    ChrSetPos(0x0000, 790, 50, 11360, 0)
    ChrSetPos(0x0001, 790, 50, 11360, 0)
    ChrSetPos(0x0002, 790, 50, 11360, 0)
    ChrSetPos(0x0003, 790, 50, 11360, 0)
...
def func_06_9BF():
    ...
    Fade(1000)
    CameraMove(-1000, 2600, 88570, 0)
    OP_67(0, 3330, -10000, 0)
    CameraSetDistance(3010, 0)
    OP_6C(9000, 0)
    OP_6E(437, 0)
    ChrSetPos(0x0101, -1150, 400, 83690, 0)
    ChrSetPos(0x0102, -2640, 400, 83590, 0)
    ChrSetPos(0x0103, -1030, 20, 81750, 0)
    ChrSetPos(0x00F9, -2430, 20, 81800, 0)
    OP_0D()
    Sleep(500)
...
def func_09_E5E():
    ...
    CameraMove(-2080, 5220, 94860, 0)
    OP_67(0, 4690, -10000, 0)
    CameraSetDistance(2270, 0)
    OP_6C(14000, 0)
    OP_6E(376, 0)
    ChrSetPos(0x0101, -2500, 4000, 94500, 0)
    ChrSetPos(0x0102, -1500, 4000, 94500, 0)
    ChrSetPos(0x00F8, -2500, 4000, 93500, 0)
    ChrSetPos(0x00F9, -1500, 4000, 93500, 0)
    OP_0D()
    CreateThread(0x0101, 0x00, 0x00, func_0A_F42)
    Sleep(300)

    CreateThread(0x0102, 0x00, 0x00, func_0B_FC7)
    Sleep(300)

    CreateThread(0x00F8, 0x00, 0x00, func_0C_104C)
    Sleep(300)

    CreateThread(0x00F9, 0x00, 0x00, func_0D_10D1)
...
def func_0E_1156():
    ...
    OP_6C(14000, 0)
    OP_6E(376, 0)
    ChrSetPos(0x0101, -1500, 4000, 96300, 180)
    ChrSetPos(0x0102, -2500, 4000, 96300, 180)
    ChrSetPos(0x00F8, -1500, 4000, 96300, 180)
    ChrSetPos(0x00F9, -2500, 4000, 96300, 180)
    ...
    FadeIn(1000, 0)
    OP_0D()
    CreateThread(0x0101, 0x00, 0x00, func_0F_12DD)
    Sleep(800)

    CreateThread(0x0102, 0x00, 0x00, func_10_133E)
    Sleep(800)

    CreateThread(0x00F8, 0x00, 0x00, func_11_139F)
    Sleep(800)

    CreateThread(0x00F9, 0x00, 0x00, func_12_1400)
    WaitForThreadExit(0x00F9, 0x0000)
    Fade(500)
    CameraMove(-2150, 4000, 93840, 0)
    OP_67(0, 9500, -10000, 0)
    CameraSetDistance(3200, 0)
    OP_6C(45000, 0)
    OP_6E(262, 0)
    ChrSetPos(0x0000, -2150, 4000, 93840, 180)
    ChrSetPos(0x0001, -2150, 4000, 93840, 180)
    ChrSetPos(0x0002, -2150, 4000, 93840, 180)
    ChrSetPos(0x0003, -2150, 4000, 93840, 180)
    OP_0D()
    EventEnd(0x00)
...
def func_0F_12DD():
    ...
    def lambda_1323():
        ChrMoveTo(0x00FE, -1500, 3600, 93500, 2000, 0x00)
...
def func_10_133E():
    ...
    def lambda_1384():
        ChrMoveTo(0x00FE, -2500, 3600, 93500, 2000, 0x00)
...
def func_11_139F():
    ...
    def lambda_13E5():
        ChrMoveTo(0x00FE, -1500, 3600, 94500, 2000, 0x00)
...
def func_12_1400():
    ...
    def lambda_1446():
        ChrMoveTo(0x00FE, -2500, 3600, 94500, 2000, 0x00)
