...
@scena.Code('ReInit')
def ReInit():
    UnlockAchievement(0x02, 0x01, 0x00, 0x00)
...
def func_03_44F():
    ...
    SetChrPos(0x0101, -20340, -280, -44000, 0)
    SetChrPos(0x0103, -19310, -320, -44000, 0)
    SetChrPos(0x00F8, -19370, -260, -45290, 0)
    SetChrPos(0x00F9, -20400, -190, -45290, 0)
