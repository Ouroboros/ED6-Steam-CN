...
@scena.Code('func_02_44D')
def func_02_44D():
    UnlockAchievement(0x02, 0x0138, 0x00)
    ...
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x046E, 6, 0x2376))
...
def func_03_569():
    UnlockAchievement(0x02, 0x0139, 0x00)
    MapSetFlags(0x08000000)
    ...
    SetMessageWindowPos(72, 320, 56, 3)
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x046F, 0, 0x2378))
...
def func_04_685():
    UnlockAchievement(0x02, 0x013A, 0x00)
    MapSetFlags(0x08000000)
    ...
    SetMessageWindowPos(72, 320, 56, 3)
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x046F, 1, 0x2379))
...
def func_05_7A1():
    UnlockAchievement(0x02, 0x013B, 0x00)
    MapSetFlags(0x08000000)
    ...
    SetMessageWindowPos(72, 320, 56, 3)
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x046F, 2, 0x237A))
...
def func_07_9D4():
    EventBegin(0x00)
    OP_A1(0x0008, 0x0001)
    ChrSetPos(0x0008, 100010, -1750, 9030, 0)
    Yield()
    Fade(1000)
    CameraMove(100010, 0, 9030, 0)
    ...
    SetScenaFlags(ScenaFlag(0x0451, 7, 0x228F))
...
def func_08_B01():
    ...
    FadeOut(0, 0, -1)
    OP_A1(0x0008, 0x0001)
    ChrSetPos(0x0008, 100010, -11750, 9030, 0)
    Yield()
    CameraMove(100010, 0, 9030, 0)
    OP_67(0, 9500, -10000, 0)
    ...
    Fade(1000)
    ChrSetPos(0x0000, 100220, 0, 4340, 180)
    ChrSetPos(0x0001, 100220, 0, 4340, 180)
    ChrSetPos(0x0002, 100220, 0, 4340, 180)
    ChrSetPos(0x0003, 100220, 0, 4340, 180)
    OP_69(0x0000, 0)
    OP_0D()
    EventEnd(0x00)
...
def func_09_C9D():
    EventBegin(0x00)
    OP_A1(0x0008, 0x0002)
    ChrSetPos(0x0008, 5130, -1750, 110010, 90)
    Yield()
    Fade(1000)
    CameraMove(5130, 0, 110010, 0)
    OP_67(0, 9500, -10000, 0)
    CameraSetDistance(3500, 0)
    OP_6C(315000, 0)
    OP_6E(262, 0)
    ...
    def lambda_0D4D():
        ChrMoveTo(0x00FE, 5130, 65000, 110010, 500, 0x00)
    ...
    def lambda_0D6D():
        CameraMove(5130, 35000, 110010, 7000)
    ...
    def lambda_0DB2():
        ChrMoveTo(0x00FE, 5130, 65000, 110010, 1000, 0x00)
    ...
    def lambda_0DD2():
        ChrMoveTo(0x00FE, 5130, 65000, 110010, 2500, 0x00)
    ...
    def lambda_0DF2():
        ChrMoveTo(0x00FE, 5130, 65000, 110010, 4000, 0x00)
    ...
    def lambda_0E12():
        ChrMoveTo(0x00FE, 5130, 65000, 110010, 6000, 0x00)
    ...
    def lambda_0E32():
        ChrMoveTo(0x00FE, 5130, 65000, 110010, 9000, 0x00)
    ...
    SetScenaFlags(ScenaFlag(0x0452, 0, 0x2290))
    ClearScenaFlags(ScenaFlag(0x0452, 1, 0x2291))
    ClearScenaFlags(ScenaFlag(0x0452, 2, 0x2292))
    ClearScenaFlags(ScenaFlag(0x0452, 3, 0x2293))
    ClearScenaFlags(ScenaFlag(0x0452, 4, 0x2294))
...
def func_0A_E8C():
    ...
    FadeOut(0, 0, -1)
    OP_A1(0x0008, 0x0002)
    ChrSetPos(0x0008, 5130, 66000, 110010, 90)
    Yield()
    CameraMove(5130, 48000, 110010, 0)
    ...
    def lambda_0F3B():
        CameraMove(5130, 0, 110010, 10000)
    ...
    def lambda_0F87():
        ChrMoveTo(0x00FE, 5130, -1750, 110010, 8000, 0x00)
    ...
    def lambda_0FA7():
        ChrMoveTo(0x00FE, 5130, -1750, 110010, 5000, 0x00)
    ...
    def lambda_0FC7():
        ChrMoveTo(0x00FE, 5130, -1750, 110010, 2500, 0x00)
    ...
    def lambda_0FE7():
        ChrMoveTo(0x00FE, 5130, -1750, 110010, 1000, 0x00)
    ...
    def lambda_1007():
        ChrMoveTo(0x00FE, 5130, -1750, 110010, 500, 0x00)
    ...
    Fade(1000)
    ChrSetPos(0x0000, 190, 0, 109990, 270)
    ChrSetPos(0x0001, 190, 0, 109990, 270)
    ChrSetPos(0x0002, 190, 0, 109990, 270)
    ChrSetPos(0x0003, 190, 0, 109990, 270)
    OP_69(0x0000, 0)
    OP_0D()
    EventEnd(0x00)
