...
def PreInit():
    EventBegin(0x00)
    Fade(1000)
    SetChrPos(0x0008, -1700, 0, 2400, 192)
    SetChrPos(0x0101, -2340, 0, 450, 0)
    SetChrPos(0x00F7, -1190, 0, 350, 0)
    SetChrPos(0x00F8, -2290, 0, -670, 0)
    SetChrPos(0x00F9, -1120, 0, -670, 0)
    OP_6D(-2000, 0, 50, 0)
