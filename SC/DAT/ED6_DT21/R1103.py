...
# id: 0x0001 offset: 0x26F
@scena.Code('Init')
def Init():
    OP_16(0x02, 0x00000FA0, 0xFFF9BE70, 0xFFFE17B8, 0x00230018)
...
# id: 0x0003 offset: 0x2E1
@scena.Code('func_03_2E1')
def func_03_2E1():
    FadeOut(300, 0, 100)
    SetChrName('')
    SetMessageWindowPos(-1, -1, -1, -1)
