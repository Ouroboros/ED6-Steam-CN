...
@scena.Code('ReInit')
def ReInit():
    UnlockAchievement(0x02, 0x67, 0x00, 0x00)
...
def func_03_32A():
    UnlockAchievement(0x02, 0x68, 0x00, 0x00)
    SetMapFlags(0x08000000)
...
def func_0E_ACC():
    ...
    SetChrPos(0x0000, 50, 250, 82510, 180)
    SetChrPos(0x0001, 50, 250, 82510, 180)
    SetChrPos(0x0002, 50, 250, 82510, 180)
    SetChrPos(0x0003, 50, 250, 82510, 180)
    EventEnd(0x00)
