...
def func_01_213():
    ...
    CreateThread(0x0008, 0x00, 0x00, func_07_B2F)
...
@scena.Code('func_02_3AF')
def func_02_3AF():
    UnlockAchievement(0x02, 0x00BE, 0x00)
    ...
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x02AC, 0, 0x1560))
...
def func_03_4CB():
    UnlockAchievement(0x02, 0x00BF, 0x00)
    MapSetFlags(0x08000000)
    ...
    SetMessageWindowPos(72, 320, 56, 3)
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x02AC, 1, 0x1561))
...
def func_04_5E7():
    ...
    Fade(1000)
    CameraMove(2350, 0, -14430, 0)
    OP_67(0, 3840, -10000, 0)
    CameraSetDistance(3740, 0)
    OP_6C(150000, 0)
    OP_6E(328, 0)
    CreateThread(0x0008, 0x03, 0x00, func_09_C50)
    PlayEffect(0x8D, 0xFF, 0xFFFF, 0, 0, 0, 0, 0, 0, 1000, 1000, 1000, 0x00FF, 0, 0, 0, 0)
    OP_C1(0x8D, 0x01, 0x0000006E)
    OP_0D()
    ChrSetPos(0x0101, -19860, 0, 6880, 90)
    ChrSetPos(0x0107, -21170, 0, 7130, 90)
    ChrSetPos(0x00F7, -19760, 0, 8160, 90)
    ChrSetPos(0x00F9, -21470, 0, 8690, 90)
