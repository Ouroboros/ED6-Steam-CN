...
def func_03_4BF():
    UnlockAchievement(0x02, 0x42, 0x01, 0x00)
...
def func_04_5DB():
    UnlockAchievement(0x02, 0x43, 0x01, 0x00)
    SetMapFlags(0x08000000)
...
def func_05_6F7():
    UnlockAchievement(0x02, 0x44, 0x01, 0x00)
    SetMapFlags(0x08000000)
...
def func_06_813():
    UnlockAchievement(0x02, 0x45, 0x01, 0x00)
    SetMapFlags(0x08000000)
...
def func_07_92F():
    UnlockAchievement(0x02, 0x46, 0x01, 0x00)
    SetMapFlags(0x08000000)
...
def func_08_A4B():
    UnlockAchievement(0x02, 0x47, 0x01, 0x00)
    SetMapFlags(0x08000000)
...
def func_0B_E65():
    EventBegin(0x00)
    OP_A1(0x0008, 0x0002)
    SetChrPos(0x0008, 100050, -1750, 9110, 0)
    Yield()
    Fade(1000)
    ...
    def lambda_0F15():
        OP_8F(0x00FE, 100050, 65000, 9110, 500, 0x00)
    ...
    def lambda_0F7A():
        OP_8F(0x00FE, 100050, 65000, 9110, 1000, 0x00)
    ...
    def lambda_0F9A():
        OP_8F(0x00FE, 100050, 65000, 9110, 2500, 0x00)
    ...
    def lambda_0FBA():
        OP_8F(0x00FE, 100050, 65000, 9110, 4000, 0x00)
    ...
    def lambda_0FDA():
        OP_8F(0x00FE, 100050, 65000, 9110, 6000, 0x00)
    ...
    def lambda_0FFA():
        OP_8F(0x00FE, 100050, 65000, 9110, 9000, 0x00)
...
def func_0C_1054():
    ...
    FadeOut(0, 0, -1)
    OP_A1(0x0008, 0x0002)
    SetChrPos(0x0008, 100050, 66000, 9110, 0)
    Yield()
    ...
    def lambda_114F():
        OP_8F(0x00FE, 100050, -1750, 9110, 8000, 0x00)
    ...
    def lambda_116F():
        OP_8F(0x00FE, 100050, -1750, 9110, 5000, 0x00)
    ...
    def lambda_118F():
        OP_8F(0x00FE, 100050, -1750, 9110, 2500, 0x00)
    ...
    def lambda_11AF():
        OP_8F(0x00FE, 100050, -1750, 9110, 1000, 0x00)
    ...
    def lambda_11CF():
        OP_8F(0x00FE, 100050, -1750, 9110, 500, 0x00)
    ...
    Fade(1000)
    SetChrPos(0x0000, 99940, 0, 4350, 180)
    SetChrPos(0x0001, 99940, 0, 4350, 180)
    SetChrPos(0x0002, 99940, 0, 4350, 180)
    SetChrPos(0x0003, 99940, 0, 4350, 180)
