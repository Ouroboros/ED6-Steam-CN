...
@scena.Code('func_01_244')
def func_01_244():
    Return()

# id: 0x0002 offset: 0x245
@scena.Code('func_02_245')
def func_02_245():
    EventBegin(0x00)
    FadeIn(2000, 0)
    ChrSetPos(0x0101, 980, -1250, -29000, 0)
    ChrSetPos(0x0102, -480, -1250, -29000, 0)
    ChrSetPos(0x0008, 810, 0, 31220, 45)
    ChrSetPos(0x0009, 810, 0, 31220, 45)
