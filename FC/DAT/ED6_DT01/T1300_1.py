...
def Init():
    ...
    EventBegin(0x00)
    ChrSetPos(0x0000, -39200, 0, 31000, 0)
    ChrSetPos(0x0001, -39200, 0, 32200, 0)
    ChrSetPos(0x0002, -39200, 0, 33400, 0)
    ChrSetPos(0x000A, -39200, 0, 34600, 0)
    ...
    Fade(1000)
    ChrSetPos(0x0101, -51000, 0, 18400, 180)
    ChrSetPos(0x0102, -50000, 0, 20000, 180)
    ChrSetPos(0x0103, -50000, 0, 17200, 180)
    ChrSetPos(0x000A, -48500, 0, 21500, 180)
    OP_69(0x0101, 0)
    ...
    CloseMessageWindow()
    ChrSetPos(0x000B, -50000, 500, 8700, 0)
    ...
    DispatchAsync2(0x0101, 0x0001, lambda_033B)
    ...
    DispatchAsync2(0x0102, 0x0001, lambda_034C)
    ...
    DispatchAsync2(0x0103, 0x0001, lambda_035D)

    @scena.Lambda('lambda_036E')
    def lambda_036E():
    ...
    DispatchAsync2(0x000A, 0x0001, lambda_036E)
    ...
    DispatchAsync2(0x0101, 0x0001, lambda_064E)
    ...
    DispatchAsync2(0x0102, 0x0001, lambda_065F)
    ...
    DispatchAsync2(0x0103, 0x0001, lambda_0670)
...
# id: 0x0001 offset: 0x90F
@scena.Code('func_01_90F')
def func_01_90F():
    OP_A6(0x0001)
...
# id: 0x0002 offset: 0x92A
@scena.Code('func_02_92A')
def func_02_92A():
    OP_A6(0x0002)
...
# id: 0x0003 offset: 0x959
@scena.Code('func_03_959')
def func_03_959():
    OP_A6(0x0003)
...
# id: 0x0004 offset: 0x988
@scena.Code('func_04_988')
def func_04_988():
    OP_A6(0x0004)
...
# id: 0x0005 offset: 0x9B7
@scena.Code('func_05_9B7')
def func_05_9B7():
    OP_A6(0x0005)
...
# id: 0x0006 offset: 0xA13
@scena.Code('func_06_A13')
def func_06_A13():
    OP_A6(0x0006)
