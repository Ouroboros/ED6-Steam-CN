...
# id: 0x0001 offset: 0x163
@scena.Code('func_01_163')
def func_01_163():
    If(
        (
            (Expr.TestScenaFlags, ScenaFlag(0x0095, 3, 0x4AB)),
            Expr.Ez,
            Expr.Return,
        ),
        'loc_175',
...
# id: 0x0002 offset: 0x17D
@scena.Code('func_02_17D')
def func_02_17D():
    ...
    FadeIn(300, 0)
    SetScenaFlags(ScenaFlag(0x0095, 3, 0x4AB))
