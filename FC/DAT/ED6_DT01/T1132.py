...
def PreInit():
    ...
    SetChrPos(0x0009, -49700, 0, 119900, 0)
    ...
    SetChrPos(0x0009, -128400, 0, 139800, 0)
    ...
    SetChrPos(0x0009, -84700, 0, 152800, 0)
    ...
    SetChrPos(0x0009, -84300, 0, 119900, 0)
    ...
    SetChrPos(0x0009, -124300, 0, 179000, 0)
