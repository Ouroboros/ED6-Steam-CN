...
def PreInit():
    ...
    SetChrPos(0x0010, 28100, 0, 22440, 0)
    ...
    SetChrPos(0x0008, -1720, 0, 24500, 275)
    ClearChrFlags(0x000D, 0x0080)
    SetChrPos(0x000D, -4050, 0, -3180, 348)
    ...
    SetChrPos(0x000B, -4740, 0, 2840, 90)
    ClearChrFlags(0x000F, 0x0080)
    SetChrPos(0x000F, -3450, 0, 2830, 270)
