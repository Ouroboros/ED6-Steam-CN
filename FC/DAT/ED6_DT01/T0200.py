...
# id: 0x0003 offset: 0x363
@scena.Code('func_03_363')
def func_03_363():
    EventBegin(0x00)
    ...
    OP_6C(135000, 0)
    ChrSetPos(0x0101, 1770, 0, 690, 270)
    ChrSetPos(0x0102, 1640, 0, -790, 270)
    ChrSetPos(0x0008, -450, 0, -60, 90)
...
# id: 0x0004 offset: 0x9AB
@scena.Code('func_04_9AB')
def func_04_9AB():
