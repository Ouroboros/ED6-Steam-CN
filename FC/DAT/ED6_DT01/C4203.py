...
def func_02_209():
    ...
    FadeOut(1000, 0, -1)
    OP_0D()
    ChrSetPos(0x0102, -101200, 0, 61500, 0)
    ChrSetPos(0x0108, -100610, 0, 59330, 0)
    ChrSetPos(0x0104, -101480, 0, 59880, 0)
    Sleep(500)
...
# id: 0x0003 offset: 0x63E
@scena.Code('func_03_63E')
def func_03_63E():
