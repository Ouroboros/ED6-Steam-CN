...
def func_05_F8F():
    ...
    ChrSetPos(0x0104, 0, 5000, -10200, 180)
    ChrSetPos(0x0103, 0, 5000, -1650, 180)
    FadeIn(2000, 0)
    OP_0D()
    ...
    DispatchAsync(0x0101, 0x0001, lambda_143C)
    ...
    DispatchAsync(0x0101, 0x0001, lambda_147B)
    ...
    ChrTalk(
        ...
        (
            ...
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0041050004V大陆上仅有的四个Ｓ级游击士之一。',
            TxtCtl.Enter,
            TxtCtl.Clear,
            '#0041050005V『剑圣』卡西乌斯·布莱特。',
            TxtCtl.Enter,
        ),
    )
