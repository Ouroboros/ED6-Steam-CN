...
def ReInit():
    ...
    SetChrPos(0x0101, 1200, 0, 47440, 0)
    SetChrPos(0x0102, -10, 0, 47200, 45)
    ...
    SetChrPos(0x0107, 2240, 0, 46790, 0)
    ...
    SetChrPos(0x0106, 940, 0, 45200, 0)
...
# id: 0x0003 offset: 0x1446
@scena.Code('func_03_1446')
def func_03_1446():
    EventBegin(0x00)
    EventEnd(0x00)
