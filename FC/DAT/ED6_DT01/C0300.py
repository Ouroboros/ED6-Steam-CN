...
def func_02_299():
    ...
    OP_6C(0, 0)
    OP_6E(262, 0)
    ChrSetPos(0x0101, -18840, -230, -46470, 0)
    ChrSetPos(0x0102, -20460, -330, -47080, 0)
    ChrSetPos(0x0103, -19740, -300, -45510, 0)
    FadeIn(1000, 0)
...
# id: 0x0003 offset: 0x547
@scena.Code('func_03_547')
def func_03_547():
...
# id: 0x0005 offset: 0x741
@scena.Code('func_05_741')
def func_05_741():
    EventBegin(0x00)
