...
def func_02_2E6():
    ...
    OP_6C(315000, 0)
    OP_6E(262, 0)
    ChrSetPos(0x0101, -90, 0, 52000, 270)
    ChrSetPos(0x0102, 1380, 0, 52150, 270)
...
# id: 0x0003 offset: 0x58B
@scena.Code('func_03_58B')
def func_03_58B():
...
# id: 0x0005 offset: 0x7F3
@scena.Code('func_05_7F3')
def func_05_7F3():
    FadeOut(300, 0, 100)
    TalkSetChrName('')
